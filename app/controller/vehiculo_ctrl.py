...
class Vehiculo_ctrl:
    ''' Class Moto_controller is used to CRUD OPS with the model. '''
    ...
    def crear_moto(self) -> object:
        ...
        data: list = []
        prompts: list = [
            'Capacidad (en litros)', 'Número de cambios', 'Aceleración inicial (m/s^2)', 'Determine el nivel de agilidad de la moto (1 al 10)'
        ]
